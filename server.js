...
var SampleApp = function() {
    ...
    self.createRoutes = function() {
        ...
        self.routes['/hello.txt'] = function(req, res) {
            res.send('Hello World');
        };
		
        self.routes['/jsonhello'] = function(req, res) {
            res.json({message : "json Hello World"});
        };
		
        self.routes['/employees'] = function(req, res) {
            res.json(employees);
        };
		
        self.routes['/employees/:index'] = function(req, res) {
            var index = req.params.index;
            res.json(employees[index]);
        };
		
		
        self.routes['/employees/:index/project'] = function(req, res){
            var index = req.params.index;
            res.json(employees[index].projects);
        };

        self.routes['/employees/:index/project/:projectindex'] = function(req, res){
            var index = req.params.index;
